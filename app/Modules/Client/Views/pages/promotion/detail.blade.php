                    ...
                    <div class="sidebar-wrapper">
                        <div class="box-sidebar">
                            ...
                            <div class="content-box">
                                ...
                                <div class="media">
                                    <a href="{!! route('client.promotion_news.detail', $item_relate->slug) !!}"><img class="mr-3" src="{!! asset('public/uploads').'/'.$item_relate->img_url !!}" alt="{!! ($title = trans('variable.title') ) ? $item_relate->$title : null !!}"></a>
                                    <div class="media-body">
                                        <h5 class="mb-3"><a href="{!! route('client.promotion_news.detail', $item_relate->slug) !!}">{!! ($title = trans('variable.title') ) ? $item_relate->$title : null !!}</a></h5>
                                        <div class="media-content">
                                            <a href="{!! route('client.promotion_news.detail', $item_relate->slug) !!}">
