                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="wrap-center">
                            <a href="{!! route('admin.video.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Thêm</a>
      ...
      $(document).ready(function(){
        ...
        var table = $('table').DataTable({
            ...
            columns: [
               ...
               {data: 'name_vi', name: 'Tên Video', title: 'Tên Video'},
               {data: 'video_url', name: 'Video ID', title: 'Video ID', 'orderable': false},
           ...
           initComplete: function(){
                ...
                $('#btn-updateOrder').click(function(){
                    ...
                    $.ajax({
                        url: '{{route("admin.video.postAjaxUpdateOrder")}}',
                        type:'POST',
                ...
                $('table.table').on('change','input[name=status]', function(){
                    ...
                    console.log(id_item);
                    $.ajax({
                        url: "{{route('admin.video.updateStatus')}}",
                        type : 'POST',
