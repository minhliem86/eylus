...
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                {!!  Form::model($inst, ['route'=>['admin.video.update',$inst->id], 'method'=>'put' ])!!}
                ...
                <div class="card-body">
                    <fieldset class="form-group">
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">Tên Video</label>
                            <div class="col-md-9">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade active show" id="name_vi" role="tabpanel" aria-labelledby="pills-name_vi">
                                        {{Form::text('name_vi',old('name_vi'), ['class'=>'form-control', 'placeholder'=>'Title'])}}
                                    </div>
                                    <div class="tab-pane fade" id="name_en" role="tabpanel" aria-labelledby="pills-name_en">
                                        {{Form::text('name_en',old('name_en'), ['class'=>'form-control', 'placeholder'=>'Title'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
