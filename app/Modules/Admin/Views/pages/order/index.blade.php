      ...
      $(document).ready(function(){
        ...
        var table = $('table').DataTable({
            ...
            columns: [
               ...
               {data: 'name', name: 'name', title: 'Mã Đơn Hàng'},
               {data: 'total', name: 'total', title: 'Giá Trị'},
               {data: 'customer_id', name: 'customer_id', title: 'Khách Hàng'},
               {data: 'paymentmethod_id', name: 'paymentmethod_id', title: 'Phương Thức Thanh Toán'},
               {data: 'shipstatus_id', name: 'shipstatus_id', title: 'Trạng Thái'},
           ...
           initComplete: function(){
                ...
                $('#btn-updateOrder').click(function(){
                    ...
                    $.ajax({
                        url: '{{route("admin.order.postAjaxUpdateOrder")}}',
                        type:'POST',
